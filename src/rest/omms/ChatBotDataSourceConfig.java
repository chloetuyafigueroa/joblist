...
public class ChatBotDataSourceConfig implements ServletContextListener {
    ...
    private static void initializeDataSource()  {
        ...
        config.setJdbcUrl("jdbc:postgresql://172.21.102.60:5432/rasa_db");
        config.setUsername("postgres");
        config.setPassword("5227728");
