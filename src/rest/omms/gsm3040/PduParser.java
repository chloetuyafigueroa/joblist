...
import rest.omms.PDUConverter;
import rest.omms.gsm3040.ie.*;
...
public class PduParser
{
	...
	private Pdu parseStart()
	{
		...
		if (addressLength > 0)
		{
			...
			//Calendar smscTimeStamp=readTimeStamp();
			...
			//System.out.println(pdu.formatTimestamp(readTimeStamp()));
			
			//pdu.setSmscTimeStamp(smscTimeStamp);
		}
		else
		{
			// first octet - determine how to parse and how to store
	...
	private void parseSmsDeliverMessage(SmsDeliveryPdu pdu)
	{
		...
		// user data
		//System.out.println("here iam"+timestamp);
		parseUserData(pdu);
	}
